...
import de.evoila.cf.cpi.bosh.deployment.manifest.instanceGroup.InstanceJob;
...
public class Manifest {
    ...
    private List<InstanceJob> jobs = new ArrayList<>(); // Alternative to Instancegroup when deploying a single Job
    ...
    public List<InstanceJob> getJobs() { return jobs; }

    public void setJobs(List<InstanceJob> jobs) { this.jobs = jobs; }
